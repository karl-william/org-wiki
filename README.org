...
* kwr-wiki
This was forked to add extra functionality more pertinent for my own uses.
** Removed unnecessary functionality such as support for images.
** Added "quick-links" and support for pdf integration.
* Org-wiki 
** Overview 
